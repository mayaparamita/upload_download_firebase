...
class LoginSignupPage2 extends StatefulWidget {
  LoginSignupPage2({this.auth, this.loginCallback});
...
//  }
    ...
    return new Padding(
        ...
        child: SizedBox(
          ...
          child: new RaisedButton(
            ...
            color: _isLoginForm? Colors.blue : Colors.grey,
            child: new Text(_isLoginForm ? 'Face Recognition Login' : 'Upload Selfie',
  ...
  Widget showConnector() {
    return Padding(
        ...
        child: Center(
          child: new Text(_isLoginForm? '- or -':'- and -',
              style: TextStyle(
                  fontSize: 20.0,
...
//  Widget showUploadSelfie() {
//    return new Padding(
//        padding: EdgeInsets.fromLTRB(0.0, 100.0, 00.0, 0.0),
//        child: SizedBox(
//          height: 30.0,
//          child: ButtonTheme (
//            //minWidth: 20,
